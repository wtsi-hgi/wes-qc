...
def _expand_cvars_str(
    base_config: dict, str_with_cvar: str, fieldname: str, as_path: bool = False, undefined_ok: bool = False
):
    """
...
def parse_config_file(file_obj, additional_cvar_shortcuts: dict = dict()):
    ...
    # TODo: clean up old code after testing OmegaConf
    config = OmegaConf.to_container(OmegaConf.load(file_obj), resolve=True)
