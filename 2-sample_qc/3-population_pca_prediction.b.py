...
def merge_and_prun (mt: hl.MatrixTable, kg_mt: hl.MatrixTable, long_range_ld_file: str, pops_file: str, merged_mt_file: str, pruned_mt_file: str):
...
def run_prun_and_pca(filtered_mt_file: str, kg_mt_file: str, long_range_ld_file: str, pops_file: str, mtdir: str, pca_scores_file: str, pca_1kg_scores_file: str, pca_1kg_loadings_file: str, pca_1kg_evals_file: str):
    '''
    ...
    merged_mt_file=mtdir+"merged_with_1kg_filtered.mt"
    pruned_mt_file=mtdir+"pruned_with_1kg_filtered.mt"
    merge_and_prun(mt, kg_mt, long_range_ld_file, pops_file, merged_mt_file, pruned_mt_file)

    run_pca(pruned_mt_file, pca_scores_file, pca_1kg_scores_file, pca_1kg_loadings_file, pca_1kg_evals_file)
...
def main():
    ...
    #initialise hail
    tmp_dir = "file:///lustre/scratch126/teams/hgi/jd41/qc/tmp/"    
    ...
    #run pca
    filtered_mt_file= mtdir + "mt_sex_annotated.mt"
    kg_mt_file="file:///lustre/scratch126/teams/hgi/gz3-fenland/matrixtables/kg_wes_regions.mt"
    pops_file=resourcedir + "igsr_samples.tsv"
    long_range_ld_file=resourcedir + "long_ld_regions.hg38.bed"
    pca_scores_file = mtdir + "pca_scores_after_pruning.ht"
    pca_1kg_scores_file = mtdir + "pca_scores_1Kg.ht"
    pca_1kg_loadings_file = mtdir + "pca_loadings_1Kg.ht"
    pca_1kg_evals_file = mtdir2 + "pca_evals_1Kg.txt"#text file may need to be without file///
    if args.pca or args.run:
        run_prun_and_pca(filtered_mt_file, kg_mt_file, long_range_ld_file, pops_file, mtdir, pca_scores_file, pca_1kg_scores_file, pca_1kg_loadings_file, pca_1kg_evals_file)
