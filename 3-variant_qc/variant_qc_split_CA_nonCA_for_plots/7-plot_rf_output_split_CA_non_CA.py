...
def create_plots(bin_htfile: str, plot_dir: str, run_hash: str, qc_plots_settings: dict):
    ...
    ht = ht.key_by('rank_id', 'contig', 'snv', 'is_CA', 'bi_allelic', 'singleton', 'trans_singletons', 'de_novo_medium_quality', 'de_novo_synonymous', 'bin')
    ...
    df = ht.to_pandas()
    #indel and SNVs dataframes - sepeare dfs for C>A and non C>A
    snvs = df[df['snv']==True]
    snvs_CA = snvs[snvs['is_CA']==True]
    snvs_non_CA = snvs[snvs['is_CA']==False]
    ...
    plotfile = plot_dir + "transmitted_singletons_CA.html"
    tabs = plot_metric(snvs_CA, 'n_trans_singletons', ['n_trans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "transmitted_singletons_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'n_trans_singletons', ['n_trans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    ...
    plotfile = plot_dir + "untransmitted_singletons_CA.html"
    tabs = plot_metric(snvs_CA, 'n_untrans_singletons', ['n_untrans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "untransmitted_singletons_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'n_untrans_singletons', ['n_untrans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    ...
    plotfile = plot_dir + "transmitted_untransmitted_CA.html"
    tabs = plot_metric(snvs_CA, 'trans_untrans_ratio', ['n_trans_singletons_synonymous_algorithm', 'n_untrans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "transmitted_untransmitted_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'trans_untrans_ratio', ['n_trans_singletons_synonymous_algorithm', 'n_untrans_singletons_synonymous_algorithm'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    ...
    plotfile = plot_dir + "r_ti_tv_CA.html"
    tabs = plot_metric(snvs_CA, 'Ti/Tv ratio', ['n_ti', 'n_tv'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "r_ti_tv_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'Ti/Tv ratio', ['n_ti', 'n_tv'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    ...
    plotfile = plot_dir + "kg_snv_CA.html"
    tabs = plot_metric(snvs_CA, 'n_kgp_high_conf_snvs', ['n_kgp_high_conf_snvs'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "kg_snv_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'n_kgp_high_conf_snvs', ['n_kgp_high_conf_snvs'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    #plot omni SNVs
    ...
    plotfile = plot_dir + "omni_snv_CA.html"
    tabs = plot_metric(snvs_CA, 'n_omni', ['n_omni'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "omni_snv_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'n_omni', ['n_omni'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    #plot mills indels
    ...
    plotfile = plot_dir + "hapmap_snvs_CA.html"
    tabs = plot_metric(snvs_CA, 'n_hapmap_snvs', ['n_hapmap'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "hapmap_snvs_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'n_hapmap_snvs', ['n_hapmap'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    #plot hapmap indels
    ...
    plotfile = plot_dir + "fail_hard_filters_snvs_CA.html"
    tabs = plot_metric(snvs_CA, 'fail_hard_filters_snvs', ['fail_hard_filters_snvs'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "fail_hard_filters_snvs_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'fail_hard_filters_snvs', ['fail_hard_filters_snvs'], qc_plots_settings, y_fun=lambda x: x[0], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
    ...
    plotfile = plot_dir + "transmitted_untransmitted_synonymous_ac_lt_10_CA.html"
    tabs = plot_metric(snvs_CA, 'trans_untrans_ratio_synonymous_ac_lt_10', ['n_trans_ac_lt_10', 'n_untrans_ac_lt_10'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)

    plotfile = plot_dir + "transmitted_untransmitted_synonymous_ac_lt_10_nonCA.html"
    tabs = plot_metric(snvs_non_CA, 'trans_untrans_ratio_synonymous_ac_lt_10', ['n_trans_ac_lt_10', 'n_untrans_ac_lt_10'], qc_plots_settings, y_fun=lambda x: x[0]/x[1], plot_bi_allelics=False, plot_singletons=False, plot_bi_allelic_singletons=False, colors=colors)
    output_file(filename=plotfile)
    save(tabs)
