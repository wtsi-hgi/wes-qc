...
def create_rf_ht(mtfile: str, truthset_file: str, allele_data_file: str, allele_counts_file: str, inbreeding_file: str, htfile_rf_all_cols: str, htfile_rf_var_type_all_cols: str):
    '''
...
def main():
   ...
   #mtfile = mtdir + "mt_pops_QC_filters_sequencing_location_and_superpop_sanger_only_after_sample_qc.mt"
    ...
    create_rf_ht(mtfile, truthset_file, allele_data_file, allele_counts_file, inbreeding_file, htfile_rf_all_cols, htfile_rf_var_type_all_cols)
