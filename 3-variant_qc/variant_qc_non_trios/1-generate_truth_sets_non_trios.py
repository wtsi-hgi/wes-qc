...
def create_inbreeding_ht_with_ac_and_allele_data(varqc_mtfile: str, inbreeding_htfile: str, qc_ac_htfile: str, allele_data_htfile: str):
    '''
...
def main():
    ...
    if args.annotation or args.all:
        ...
        create_inbreeding_ht_with_ac_and_allele_data(varqc_mtoutfile, inbreeding_htoutfile, qc_ac_htoutfile, allele_data_htoutfile)
