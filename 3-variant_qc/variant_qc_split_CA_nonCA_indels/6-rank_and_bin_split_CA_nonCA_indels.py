...
# adapted for separate RFs for C>A, non-C>A and indels
import hail as hl
import pyspark
import argparse
...
def main():
    ...
    for run_hash in run_hashes:
        # add rank
        htfile = rf_dir + run_hash+ "/rf_result_final_for_ranking.ht"
        htrankedfile = rf_dir + run_hash + "/rf_result_ranked.ht"
        ...
        bin_tmp_htfile = rf_dir + run_hash + "/_gnomad_score_binning_tmp.ht"
