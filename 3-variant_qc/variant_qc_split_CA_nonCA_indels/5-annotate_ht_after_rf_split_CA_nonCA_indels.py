#annotate after RF
#adapted for data split into C>A, non-C>A and indels
import hail as hl
import pyspark
import argparse
...
def main():
    ...
    for run_hash in run_hashes:
        ...
        ht_cq_file = rf_dir + run_hash+ "/rf_result_with_synonymous.ht"
        ...
        family_annot_htfile = rf_dir + run_hash + "/rf_result_denovo_family_stats.ht"
        ...
        trans_sing_htfile = rf_dir + run_hash + "/rf_result_trans_sing.ht"
        ...
        final_htfile = rf_dir + run_hash + "/rf_result_final_for_ranking.ht"
