...
def main():
    gtcheck_output_file = '/lustre/scratch123/hgi/projects/birth_cohort_wes/qc/BiB/gtcheck/gtcheck_top_50_matches.txt.gz'
    outfile = '/lustre/scratch123/hgi/projects/birth_cohort_wes/qc/BiB/gtcheck/gtcheck_best_hits.txt'
