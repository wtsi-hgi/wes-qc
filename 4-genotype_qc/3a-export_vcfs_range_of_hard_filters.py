    ...
    metadata = {
        'info': {
            ...
            'rf_score': {'Description': 'Variant QC random forest score, model id ' + run_hash,
                         'Number': 'A',
                         'Type': 'Float'},
            'CSQ': {'Description': 'Consequence annotations from Ensembl VEP. Format: Allele|Consequence|IMPACT|SYMBOL|Gene|Feature_type|Feature|BIOTYPE|EXON|INTRON|HGVSc|HGVSp|cDNA_position|CDS_position|Protein_position|Amino_acids|Codons|Existing_variation|ALLELE_NUM|DISTANCE|STRAND|FLAGS|VARIANT_CLASS|SYMBOL_SOURCE|HGNC_ID|CANONICAL|MANE_SELECT|MANE_PLUS_CLINICAL|TSL|APPRIS|CCDS|ENSP|SWISSPROT|TREMBL|UNIPARC|UNIPROT_ISOFORM|GENE_PHENO|SIFT|PolyPhen|DOMAINS|miRNA|HGVS_OFFSET|AF|AFR_AF|AMR_AF|EAS_AF|EUR_AF|SAS_AF|gnomADe_AF|gnomADe_AFR_AF|gnomADe_AMR_AF|gnomADe_ASJ_AF|gnomADe_EAS_AF|gnomADe_FIN_AF|gnomADe_NFE_AF|gnomADe_OTH_AF|gnomADe_SAS_AF|gnomADg_AF|gnomADg_AFR_AF|gnomADg_AMI_AF|gnomADg_AMR_AF|gnomADg_ASJ_AF|gnomADg_EAS_AF|gnomADg_FIN_AF|gnomADg_MID_AF|gnomADg_NFE_AF|gnomADg_OTH_AF|gnomADg_SAS_AF|MAX_AF|MAX_AF_POPS|CLIN_SIG|SOMATIC|PHENO|PUBMED|MOTIF_NAME|MOTIF_POS|HIGH_INF_POS|MOTIF_SCORE_CHANGE|TRANSCRIPTION_FACTORS|SpliceRegion|GeneSplicer|existing_InFrame_oORFs|existing_OutOfFrame_oORFs|existing_uORFs|five_prime_UTR_variant_annotation|five_prime_UTR_variant_consequence|CADD_PHRED|CADD_RAW|AlphaMissense_pred|AlphaMissense_rankscore|AlphaMissense_score|Ensembl_transcriptid|LRT_pred|MutationTaster_pred|Polyphen2_HDIV_pred|Polyphen2_HVAR_pred|PrimateAI_pred|PrimateAI_rankscore|PrimateAI_score|SIFT_pred|Uniprot_acc|VEP_canonical|DisGeNET_PMID|DisGeNET_SCORE|PHENOTYPES|Conservation|LoF|LoF_filter|LoF_flags|LoF_info|REVEL|SpliceAI_pred_DP_AG|SpliceAI_pred_DP_AL|SpliceAI_pred_DP_DG|SpliceAI_pred_DP_DL|SpliceAI_pred_DS_AG|SpliceAI_pred_DS_AL|SpliceAI_pred_DS_DG|SpliceAI_pred_DS_DL|SpliceAI_pred_SYMBOL|EVE_CLASS|EVE_SCORE|Enformer_SAD|Enformer_SAR|MaveDB_a1_score|MaveDB_a1_se|MaveDB_a2_score|MaveDB_a2_se|MaveDB_a3_score|MaveDB_a3_se|MaveDB_a_score|MaveDB_a_se|MaveDB_accession|MaveDB_b1_score|MaveDB_b1_se|MaveDB_b2_score|MaveDB_b2_se|MaveDB_b3_score|MaveDB_b3_se|MaveDB_b_score|MaveDB_b_se|MaveDB_base_scaled|MaveDB_ci_high|MaveDB_ci_low|MaveDB_coverage|MaveDB_df|MaveDB_dna_sequences|MaveDB_dtype|MaveDB_e1_score|MaveDB_e2_score|MaveDB_e3_score|MaveDB_e4_score|MaveDB_ei|MaveDB_epsilon|MaveDB_frame|MaveDB_hgvs|MaveDB_high_conf|MaveDB_indel|MaveDB_lower_ci|MaveDB_nt|MaveDB_obs|MaveDB_pro|MaveDB_publish_date|MaveDB_pubmed|MaveDB_pvalue|MaveDB_reads|MaveDB_refseq|MaveDB_rna_sequences|MaveDB_score|MaveDB_score_101208|MaveDB_score_110307|MaveDB_score_pluse2newrep3|MaveDB_score_pluse2newrep4|MaveDB_score_pluse2newrep5|MaveDB_score_pluse2rep3|MaveDB_score_pluse2rep4|MaveDB_score_pluse2rep5|MaveDB_score_replicate_1|MaveDB_score_replicate_2|MaveDB_score_replicate_3|MaveDB_score_replicate_4|MaveDB_score_replicate_5|MaveDB_score_replicate_6|MaveDB_score_replicate_a|MaveDB_score_replicate_b|MaveDB_score_replicate_c|MaveDB_score_replicate_d|MaveDB_score_replicate_e|MaveDB_score_replicate_f|MaveDB_score_y2h_1_rep1|MaveDB_score_y2h_1_rep2|MaveDB_score_y2h_1_rep3|MaveDB_score_y2h_2_rep1|MaveDB_score_y2h_2_rep2|MaveDB_score_y2h_2_rep3|MaveDB_sd|MaveDB_se|MaveDB_se_101208|MaveDB_se_110307|MaveDB_se_pluse2newrep3|MaveDB_se_pluse2newrep4|MaveDB_se_pluse2newrep5|MaveDB_se_pluse2rep3|MaveDB_se_pluse2rep4|MaveDB_se_pluse2rep5|MaveDB_se_replicate_1|MaveDB_se_replicate_2|MaveDB_se_replicate_3|MaveDB_se_replicate_4|MaveDB_se_replicate_5|MaveDB_se_replicate_6|MaveDB_se_replicate_a|MaveDB_se_replicate_b|MaveDB_se_replicate_c|MaveDB_se_replicate_d|MaveDB_se_replicate_e|MaveDB_se_replicate_f|MaveDB_se_y2h_1_rep1|MaveDB_se_y2h_1_rep2|MaveDB_se_y2h_1_rep3|MaveDB_se_y2h_2_rep1|MaveDB_se_y2h_2_rep2|MaveDB_se_y2h_2_rep3|MaveDB_single_plex_mean|MaveDB_single_plex_stderr|MaveDB_splice|MaveDB_unique_tags|MaveDB_upper_ci|MaveDB_urn|MaveDB_vtype|RiboseqORFs_CDS_position|RiboseqORFs_amino_acids|RiboseqORFs_cDNA_position|RiboseqORFs_codons|RiboseqORFs_consequences|RiboseqORFs_id|RiboseqORFs_impact|RiboseqORFs_protein_position|RiboseqORFs_publications|AA|OpenTargets_geneId|OpenTargets_geneName|OpenTargets_geneSymbol|OpenTargets_l2g|LoFtool|VARITY_ER|VARITY_ER_LOO|VARITY_R|VARITY_R_LOO|BayesDel|am_class|am_pathogenicity',
                    'Number': 'A',
                    'Type': 'String'},
