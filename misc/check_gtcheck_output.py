...
# check that the identifier matches that in the mapping file and that the score is good (< 0.05)
...
def main():
    gtcheck_output_file = '/lustre/scratch123/hgi/projects/birth_cohort_wes/qc/compare_broad_sanger_vcfs/gtcheck_best_hits.txt'
    expected_pairs_file = '/lustre/scratch123/hgi/projects/birth_cohort_wes/qc/compare_broad_sanger_vcfs/sample_mapping.txt'
    output_file = '/lustre/scratch123/hgi/projects/birth_cohort_wes/qc/compare_broad_sanger_vcfs/gtcheck_analysis.txt'
